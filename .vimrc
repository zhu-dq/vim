...
"nmap <F5> :wa<CR>:cd ../build/<CR>:!rm -rf main<CR>:!cmake CMakeLists.txt<CR>:make<CR><CR>:cw<CR>:cd ..<CR>:!build/main<CR>:cw
 noremap <F2> :cd ..<CR>:!ctags -R<CR> 
nmap <F5> :wa<CR>:cd ../build/<CR>:!rm -rf main<CR>:!cmake ..<CR>:make<CR>:cw<CR>:!clear;./main<CR>
"nmap <F5> :!rm -rf main<CR>:wa<CR>:make<CR>:cw<CR><CR>:!./main<CR>
